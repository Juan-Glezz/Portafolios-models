...
# de compra relacionados con el cliente y el producto, se calculan las variables fecha, IVA e importe y 
...
def topClientes(request):
    ...
    return render(request, 'tienda/top10mejores.html', {'topClientes': clientes})

#En esta funcion, se obtiene todas las compras realizadas por el usuario actual mediante el uso de 
